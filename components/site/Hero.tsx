  ...
  return (
    <section id="top" className="relative pt-32 pb-24 md:pt-44 md:pb-36 overflow-hidden">
      ...
      <div className="absolute top-1/4 right-20 hidden md:block">
        <div className="h-2 w-2 rounded-md bg-secondary shadow-[0_0_20px_4px_var(--color-purple-glow)] animate-float" style={{ animationDelay: "1s" }} />
      </div>
      <div className="absolute bottom-24 right-1/3 hidden md:block">
        <div className="h-2.5 w-2.5 rounded-md bg-accent shadow-[0_0_20px_4px_var(--color-orange-glow)] animate-float" style={{ animationDelay: "2s" }} />
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: "150ms" }}>
          Yang Penting Kode mengubah ide kamu menjadi produk digital yang cepat,
          scalable, dan siap memenangkan pasar — dari konsep sampai launch.
        </p>
        ...
        <div className="mt-16 grid grid-cols-3 gap-6 max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: "450ms" }}>
          {[
